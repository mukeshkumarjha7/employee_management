...
RSpec.describe "employees/index", type: :view do
  ...
  before(:each) do
    assign(:employees, [
      ...
      Employee.create!(valid_attributes.merge(email: "rahul@example.com", first_name: "Rahul"))
    ])
  end
  ...
  it "renders a list of employees" do
    ...
    assert_select cell_selector, text: Regexp.new("Jha"),    count: 2
    ...
    assert_select cell_selector, text: Regexp.new("50000"),  count: 2
  end
end
